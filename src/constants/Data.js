import Myfilter from "./Jewelrytype";
import JewelaryBrand from "./JewelryBrand"
...
export const colDefs = [
  { field: "Item Nos" },
  { field: "Jewelry Type", filter: Myfilter },
  {
    field: "BRAND",
    ...
    filterParams: {
      ...
      newRowsAction: "keep",
      values: (params) => {
        const uniqueBrands = new Set(params.api.getDisplayedRowCount());
        return Array.from(uniqueBrands);
      },
      doesFilterPass: JewelaryBrand.prototype.doesFilterPass,
    },
  },
  { field: "Size #" },
  { field: "Detail" },
  { field: "Particulars" },
  { field: "Metal", filter: metal },
  { field: "Gross Wt.", filter: true, floatingFilter: true },
  { field: "Start Price in US $", filter: true, floatingFilter: true },
  { field: "Remarks" },
];
